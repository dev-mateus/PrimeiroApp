...
5) **Guia de Estilo** — material para aplicar tema e estilos. [Clique aqui](docs/STYLING_GUIDE_PRIMEIROAPP.md)
6) **Atividade prática** — crie um projeto separado aplicando o que aprendeu e publique no GitHub. [Clique aqui](docs/atividade-pratica.md)
